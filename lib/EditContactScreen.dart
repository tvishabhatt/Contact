      ...
      builder: (context,ThemeModal themeNotifiter,child) {
        return Scaffold(
         appBar: AppBar(
            ...
            title: Text(
              'Edit Contcts', style: TextStyle(color: themeNotifiter.isDark?Colors.white:Colors.black, fontSize: 20),),
            centerTitle: true,
          ),
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text('Save Changes',style: TextStyle(color: themeNotifiter.isDark?Colors.black:Colors.white),),
                ),
              ],
            ),
          ),
